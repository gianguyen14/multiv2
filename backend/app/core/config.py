...
QA_ANSWER_BACKEND = os.getenv("QA_ANSWER_BACKEND", "extractive").lower()
QA_ANSWER_URL = os.getenv("QA_ANSWER_URL", "")
QA_ANSWER_MODEL = os.getenv("QA_ANSWER_MODEL", "agent-lite")
